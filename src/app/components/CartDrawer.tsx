                ...
                {useStore.cart.map((item) => (
                    <div key={item.id} className="flex gap-4 py-4">
                        ...
                        <div>
                            ...
                            <button className="py-1 px-2 border raounded-md mt-2 text-sm mr-1" onClick={() => useStore.addProduct(item)}>
                                Adicionar
                            </button>
                            <button className="py-1 px-2 border raounded-md mt-2 text-sm mr-1" onClick={() => useStore.removeProduct(item)}>
                                Remover
                            </button>
                        </div>
                    </div>
